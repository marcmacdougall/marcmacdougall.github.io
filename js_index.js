...
function palette1() {
	...
	document.getElementById("hero").style.background = "#192BAB";
	document.getElementById("hero").style.border = "5px ridge #FFFF00";
	document.getElementById("dal-sign").style.background = "#192BAB";
	document.getElementById("dal-sign").style.border = "5px ridge #FFFF00";
	document.getElementById("table").style.background = "#192BAB";
...
function palette2() {
	...
	document.getElementById("hero").style.background = "#19A7CE";
	document.getElementById("hero").style.border = "5px ridge #A020F0";
	document.getElementById("dal-sign").style.background = "#19A7CE";
	document.getElementById("dal-sign").style.border = "5px ridge #A020F0";
	document.getElementById("table").style.background = "#19A7CE";
...
function palette3() {
	...
	document.getElementById("hero").style.background = "#6930C4";
	document.getElementById("hero").style.border = "5px ridge #16FF00";
	document.getElementById("dal-sign").style.background = "#6930C4";
	document.getElementById("dal-sign").style.border = "5px ridge #16FF00";
	document.getElementById("table").style.background = "#6930C4";

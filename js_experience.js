...
function palette1() {
	...
	document.getElementById("dal-logo").style.background = "#192BAB";
	document.getElementById("dal-logo").style.border = "5px ridge #FFFF00";
...
function palette2() {
	...
	document.getElementById("dal-logo").style.background = "#19A7CE";
	document.getElementById("dal-logo").style.border = "5px ridge #A020F0";
...
function palette3() {
	...
	document.getElementById("dal-logo").style.background = "#6930C4";
	document.getElementById("dal-logo").style.border = "5px ridge #16FF00";

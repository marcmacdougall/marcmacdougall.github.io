...
function palette1() {
	...
	document.getElementById("projects-list").style.background = "#192BAB";
...
function palette2() {
	...
	document.getElementById("projects-list").style.background = "#19A7CE";
...
function palette3() {
	...
	document.getElementById("projects-list").style.background = "#6930C4";

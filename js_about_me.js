...
function palette1() {
	...
	document.getElementById("blomidon").style.background = "#192BAB";
	document.getElementById("blomidon").style.border = "5px ridge #FFFF00";
	document.getElementById("cat").style.background = "#192BAB";
	document.getElementById("cat").style.border = "5px ridge #FFFF00";
...
function palette2() {
	...
	document.getElementById("blomidon").style.background = "#19A7CE";
	document.getElementById("blomidon").style.border = "5px ridge #A020F0";
	document.getElementById("cat").style.background = "#19A7CE";
	document.getElementById("cat").style.border = "5px ridge #A020F0";
...
function palette3() {
	...
	document.getElementById("blomidon").style.background = "#6930C4";
	document.getElementById("blomidon").style.border = "5px ridge #16FF00";
	document.getElementById("cat").style.background = "#6930C4";
	document.getElementById("cat").style.border = "5px ridge #16FF00";
